...
type FunctionRunStartParams struct {
	...
	XDbPreview          *string `json:"x-db-preview,omitempty"`
	XNotteRequestOrigin *string `json:"x-notte-request-origin,omitempty"`
	XNotteSdkVersion    *string `json:"x-notte-sdk-version,omitempty"`
}
...
func NewFunctionRunStartRequestWithBody(server string, functionId string, params *FunctionRunStartParams, contentType string, body io.Reader) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.XDbPreview != nil {
			var headerParam1 string

			headerParam1, err = runtime.StyleParamWithLocation("simple", false, "x-db-preview", runtime.ParamLocationHeader, *params.XDbPreview)
			if err != nil {
				return nil, err
			}

			req.Header.Set("x-db-preview", headerParam1)
		}

		if params.XNotteRequestOrigin != nil {
			var headerParam2 string

			headerParam2, err = runtime.StyleParamWithLocation("simple", false, "x-notte-request-origin", runtime.ParamLocationHeader, *params.XNotteRequestOrigin)
			if err != nil {
				return nil, err
			}

			req.Header.Set("x-notte-request-origin", headerParam2)
		}

		if params.XNotteSdkVersion != nil {
			var headerParam3 string

			headerParam3, err = runtime.StyleParamWithLocation("simple", false, "x-notte-sdk-version", runtime.ParamLocationHeader, *params.XNotteSdkVersion)
			if err != nil {
				return nil, err
			}

			req.Header.Set("x-notte-sdk-version", headerParam3)
		}
